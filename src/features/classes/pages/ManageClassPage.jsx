...
import { fetchSubjects } from "../../courses/subjects.api.js";
import {
  listResultsForClass,
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        // 3) Subjects
        const subsRes = await fetchSubjects({ search: `course:${cls.course}`, page: 1 });
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold">
            Manage Class — {course?.grade || course?.title || "Course"} • Class #{classData?.id}
          </h1>
          <button
